        ...
        <div class="modal-content body-form">
                <div class="form-card">
                    ...
                    <form class="form-card-form" action="/phpt/forum_project/signupheader.php" method="post">
                        ...
                        <div class="form-input">
                            <input id="signuppassword" name="signuppassword" type="password" class="form-input-field" required/>
                            <label for="exampleInputPassword1" class="form-input-label">Password</label>
                        </div>
                        <div class="form-input">
                            <input id="signupcpassword1" name="signupcpassword" type="password" class="form-input-field" required/>
